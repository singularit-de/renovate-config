...
```json
{
  ...
  "extends": [
    "github>singularit-de/renovate-config#0.0.2"
  ]
}
```
...
```json
{
  "$schema": "https://docs.renovatebot.com/renovate-schema.json",
  "extends": [
    "github>singularit-de/renovate-config:gitlab#0.0.2"
  ]
}
```
...
```json
{
  "$schema": "https://docs.renovatebot.com/renovate-schema.json",
  "extends": [
    "github>singularit-de/renovate-config:docker#0.0.2"
  ]
}
```
...
Version pins in transitive config references (e.g. `github>singularit-de/renovate-config:base#0.0.2 in `default.json`)
